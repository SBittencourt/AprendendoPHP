						...
						<div class="tt-header-col">
							...
							<div class="tt-logo"> 
								<a href="index.html">
									...
									<img src="/assets/img/stage.png" class="tt-logo-light magnetic-item" alt="Logo"> <!-- logo light -->
									<img src="/assets/img/stage.png" class="tt-logo-dark magnetic-item" alt="Logo"> <!-- logo dark -->
								</a>
							</div>
							<!-- End logo -->
									...
									<div class="tt-ol-menu-inner tt-wrap">
										<div class="tt-ol-menu-content">
											...
											<ul class="tt-ol-menu-list">
												<li class="tt-ol-submenu-wrap"> <a href="/">Home</a></li>
												<li class="tt-ol-submenu-wrap active"> <a href="/events">Events</a>	</li>
												<li class="tt-ol-submenu-wrap"><a href="about-us.php">About Us</a></li>
