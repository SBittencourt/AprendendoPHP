        <!-- Meta -->
        <meta charset="utf-8">
		<meta name="description" content="Your Id.">
		<meta name="author" content="spoten.app">

		<!-- Mobile Meta -->
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

		<!-- Favicon (http://www.favicon-generator.org/) -->
		<link rel="shortcut icon" href="/assets/img/stage.png" type="image/x-icon">
		<link rel="icon" href="/assets/img/stage.png" type="image/x-icon">
